  ...
  class PDb_Aux_Plugin {
    ...
    public function check_connection()
    {
      ...
      foreach ( $active_plugins as $plugin_file ) {
        if ( false !== stripos( $plugin_file, 'members-database.php' ) ) {
          return true;
        }
      }
      return false;
...
//          $links[] = '<a href="' . $this->plugin_data['PluginURI'] . '">' . __( 'Submit a rating or review', 'members-database' ) . ' </a>';
//        }
        $links[] = '<a href="' . $this->plugin_data['SupportURI'] . '">' . __( 'Support', 'members-database' ) . ' </a>';
      }
      return $links;
    }
    ...
    protected function set_attribution()
    {
      ...
      $name_pattern = _x( '%s version %s', 'displays the name and version of the plugin', 'members-database' );
      $author_pattern = _x( 'Authored by %s', 'displays the plugin author name', 'members-database' );
    ...
    public function settings_api_init()
    {
      ...
      $this->settings_sections = array(
          array(
              'title' => __( 'General Settings', 'members-database' ),
