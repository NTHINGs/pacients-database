...
Contributors: xnau
Donate link: https://xnau.com/wordpress-plugins/pacients-database
...
[GDPR Compliance Information](https://xnau.com/work/wordpress-plugins/pacients-database/gdpr-compliance-and-pacients-database/) for users of Participants Database
...
The latest POT file is always [available here.](http://plugins.svn.wordpress.org/pacients-database/trunk/pacients-database.pot)
...
* [Participants Database](https://xnau.com/work/wordpress-plugins/pacients-database/)
* [Participants database Documentation](https://xnau.com/work/wordpress-plugins/pacients-database/pacients-database-documentation/)
...
* [Quick Setup Guide](https://xnau.com/pacients-database-quick-setup-guide/)
...
If you are interested in having this plugin work with WordPress users, read this article: [Using Participants Database with WordPress Users](http://xnau.com/using-pacients-database-with-wordpress-users/).

= People are signing up, but emails are not getting sent =

Use my [Email Troubleshooting Flowchart](http://xnau.com/pacients-database-email-troubleshooting/) to help you diagnose the problem.
...
**[Plugin manual and documentation](https://xnau.com/work/wordpress-plugins/pacients-database/pacients-database-documentation/?utm_source=wporg_visitor&utm_medium=plugin_page_othernotes__tab&utm_campaign=pdb-addons-promo) is published on the developer's website, xnau.com**

Plugin technical support is available on the [WordPress Plugin Plugin Support Forum](https://wordpress.org/support/plugin/pacients-database), and on xnau.com in the comments section.
